        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="#" className="hover:text-white transition-colors">Mortgage Prepayment</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Investment Returns</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Retirement Planning</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Debt Payoff</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#" className="hover:text-white transition-colors">Investment Strategies</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Mortgage Guide</a></li>
